...
* The scope of the exam will correspond to chapters 2-8 of the lecture notes. You can
  print these chapters and use them during the exam. No other resources (notes, books, computers etc.)
  are permitted.
...
so that we can go over the questions during the Tuesday class meeting.  
